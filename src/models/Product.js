...
const productSchema = new mongoose.Schema(
  {
    ...
    images: [
      {
        ...
        url: {
          ...
          validate: {
            ...
            message:
              "Image URL must end with a valid image file format (e.g., jpg, jpeg, png, webp, gif).",
          },
        },
        alt: {
          type: String,
    ...
    tags: {
      ...
      validate: {
        ...
        message:
          'Each tag must be a non-empty string starting with "#" and the total tags should not exceed 10.',
      },
    },
    specialOffers: {
